    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="olahuser" class="table table-hover" width="100%" cellspacing="0">
                    <thead>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-1">
                                                ...
                                                <input type="hidden" class="form-control" id="userid" name="userid" value="<?= $usr['id']; ?>">
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <select class="form-control" id="level" name="level">
                                                    <?php
                                                    $jenisusr = $usr['jenis'];
                                                    $queryjenisusr = "SELECT jenis FROM jenis_user WHERE id=$jenisusr";
                                                    $jenisusr2 = $this->db->query($queryjenisusr)->row_array();
                                                    $jenisusr3 = $jenisusr2['jenis'];
                                                    ?>
                                                    <option value="<?= $jenisusr; ?>" selected><?= $jenisusr3; ?></option>
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <select class="form-control" id="lembaga" name="lembaga">
                                                    <?php
                                                    $lbg = $usr['kode_padukuhan'];
                                                    $querylbg = "SELECT padukuhan FROM padukuhan WHERE id=$lbg";
                                                    $baga = $this->db->query($querylbg)->row_array();
                                                    $bagal = $baga['padukuhan'];
                                                    ?>
                                                    <option value=<?= $lbg; ?> selected><?= $bagal;  ?></option>
                                                    ...
                                                    <option value="8">Pemerintah Kalurahan</option>
                                                </select>
                                            </div>
                                            <div class="mb-1">
                                                ...
                                                <select class="form-control" id="sublembaga" name="sublembaga">
                                                    <?php
                                                    $sublbg = $usr['kode_rt'];
                                                    $querysublbg = "SELECT rt FROM rt WHERE id=$sublbg";
                                                    $bagasub = $this->db->query($querysublbg)->row_array();
                                                    $bagasub2 = $bagasub['rt'];
                                                    ?>
                                                    <option value=<?= $sublbg; ?> selected><?= $bagasub2;  ?></option>
                                            ...
                                            <div class="mb-1">
                                                <label for="exampleInputMasalah" class="form-label">Aktif :</label>
                                                <select class="form-control" id="aktif" name="aktif">
                                                    <option value="<?= $usr['aktif']; ?>" selected>
                                                        <?php
                                                        if ($usr['aktif'] == 0) :
                                                            $aktip = "Tidak Aktif";
                                                        else :
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form method="POST" action="<?= base_url('admin/hapususer'); ?>">
                                                <input type="hidden" class="form-control" id="iduser" name="iduser" value="<?= $usr['id']; ?>">
